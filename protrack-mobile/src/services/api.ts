...
async function supabaseFetch<T>(path: string, options: FetchOptions = {}): Promise<T | null> {
  try {
    ...
    if (__DEV__) {
      console.log(
        '[DEBUG API] Estado da sessão:',
        session
          ? 'Sessão existe (Token: ' + session.access_token.substring(0, 10) + '...)'
          : 'Sessão NULA! ZUSTAND VAZIO.'
      );
    }
...
export async function fetchExercises(): Promise<Exercise[]> {
  ...
  return [
    ...
    },
    {
      ...
      muscle_group: 'Pernas',
      youtube_video_id: '_i6qpcI1Nw4',
      equipment: ['Barra', 'Banco'],
    },
    {
      id: 'eb9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Panturrilha em Pé',
      muscle_group: 'Pernas',
      youtube_video_id: 'ZQdqLXtNpMQ',
      equipment: ['Máquina'],
    },
    {
      ...
      name: 'Hack Squat',
      muscle_group: 'Pernas',
      youtube_video_id: 'TA5oAKI_Nxw',
      equipment: ['Máquina'],
    },
    {
      id: '0c9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Avanço com Halteres',
      muscle_group: 'Pernas',
      youtube_video_id: 'io3KJ3oN5mk',
      equipment: ['Halteres'],
    },
    {
    ...
    },
    {
      ...
      muscle_group: 'Pernas',
      youtube_video_id: 'XbhmXUYp8hs',
      equipment: ['Máquina'],
    },

    {
      id: '4c9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Levantamento Terra',
      muscle_group: 'Costas',
      youtube_video_id: 'ASO89bLkLqU',
      equipment: ['Barra'],
    },
    {
      id: '5c9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Barra Fixa',
      muscle_group: 'Costas',
      youtube_video_id: 'eGo4IWqAX8',
      equipment: ['Barra Fixa'],
    },
    {
      id: '6c9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Remada Curvada com Barra',
      muscle_group: 'Costas',
      youtube_video_id: 'cMQpvkZGQrE',
      equipment: ['Barra'],
    },
    {
      id: '7c9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Remada Unilateral com Halter',
      muscle_group: 'Costas',
      youtube_video_id: 'eeg6REnybpI',
    ...
    },
    {
      ...
      muscle_group: 'Costas',
      youtube_video_id: 'Ro45Ju8eBak',
      equipment: ['Polia Alta'],
    },
    {
      id: '9c9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Crucifixo Invertido',
      muscle_group: 'Costas',
      youtube_video_id: 'K5T1YBbKEXI',
      equipment: ['Halteres'],
    },
    {
      id: 'ac9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Remada Serrote',
      muscle_group: 'Costas',
      youtube_video_id: 'mjFIZX68F_8',
      equipment: ['Halter', 'Banco'],
    },
    {
      ...
      muscle_group: 'Costas',
      youtube_video_id: 'KquN56BZR9c',
      equipment: ['Polia Alta'],
    },

    {
      id: 'cc9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Desenvolvimento com Barra',
      muscle_group: 'Ombros',
      youtube_video_id: 'm1dtZHPSmHg',
      equipment: ['Barra'],
    },
    {
      id: 'dc9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Elevação Lateral com Halteres',
      muscle_group: 'Ombros',
      youtube_video_id: 'QlENCLwEx_Q',
      equipment: ['Halteres'],
    },
    {
      id: 'ec9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Elevação Frontal com Halteres',
      muscle_group: 'Ombros',
      youtube_video_id: 'YyNMDsPedPk',
      equipment: ['Halteres'],
    },
    {
      id: 'fc9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Encolhimento de Ombros (Shrug)',
      muscle_group: 'Ombros',
      youtube_video_id: 'Dl5jKuF4hLY',
    ...
    },
    {
      ...
      name: 'Rosca Martelo',
      muscle_group: 'Bíceps',
      youtube_video_id: 'RejYUX31uVo',
      equipment: ['Halteres'],
    },
    {
      id: '5d9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Rosca Scott',
      muscle_group: 'Bíceps',
      youtube_video_id: 'lQEE8Nvhamw',
    ...
    },
    {
      ...
      name: 'Rosca no Cabo',
      muscle_group: 'Bíceps',
      youtube_video_id: '2v1LDRklTnU',
      equipment: ['Polia Baixa'],
    },

    {
      id: '8d9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Tríceps Testa com Barra',
      muscle_group: 'Tríceps',
      youtube_video_id: '8LFsUN913r4',
      equipment: ['Barra W'],
    },
    {
      id: '9d9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Tríceps Pulley no Cabo',
      muscle_group: 'Tríceps',
      youtube_video_id: 'HFs7OiOy8TE',
      equipment: ['Polia Alta'],
    },
    {
      ...
      muscle_group: 'Tríceps',
      youtube_video_id: '4NWWB0f0vzQ',
      equipment: ['Paralelas'],
    },
    {
      id: 'bd9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Tríceps Francês com Halter',
      muscle_group: 'Tríceps',
      youtube_video_id: 'TkGyrH6EQK4',
      equipment: ['Halter'],
    },
    {
      id: 'cd9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Tríceps Mergulho no Banco',
      muscle_group: 'Tríceps',
      youtube_video_id: 'p_DeBmkbCUc',
      equipment: ['Banco'],
    },

    {
      id: 'dd9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Abdominal Crunch',
      muscle_group: 'Abdômen',
      youtube_video_id: 'P5ySsdvCMyE',
      equipment: ['Colchonete'],
    },
    {
      id: 'ed9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed',
      name: 'Prancha',
      muscle_group: 'Abdômen',
      youtube_video_id: 'ffHr8a6DRvU',
      equipment: ['Colchonete'],
    },
  ];
}

// Cache local para progresso do exercício (evitar chamadas N+1 paralelas/repetidas)
const progressCache = new Map<string, { data: any; timestamp: number }>();
const CACHE_TTL_MS = 30000; // 30 segundos

export async function fetchUserProgress(exerciseId: string): Promise<any> {
  const now = Date.now();
  const cached = progressCache.get(exerciseId);
